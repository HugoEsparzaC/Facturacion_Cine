...
class Cliente(tk.Tk):
    ...
    def _creacion_componentes(self):
        ...
        # Plantilla divisoria
        # =============================================================================================
        ABC = tk.Frame(self, bg='green', bd=20, relief=tk.RIDGE)
        ABC.grid()
        ABC1 = tk.Frame(ABC, bd=14, width=1350, height=100, padx=10, bg='green', relief=tk.RIDGE)
        ABC1.grid(row=0, column=0, columnspan=4, sticky='n')
        ABC2 = tk.Frame(ABC, bd=14, width=450, height=488, padx=10, bg='forest green', relief=tk.RIDGE)
        ABC2.grid(row=1, column=0, sticky='N')
        ABC3 = tk.Frame(ABC, bd=14, width=450, height=488, padx=10, bg='green', relief=tk.RIDGE)
        ABC3.grid(row=1, column=1, sticky='N')
        ABC4 = tk.Frame(ABC, bd=14, width=460, height=488, padx=0, bg='forest green', relief=tk.RIDGE)
        ABC4.grid(row=1, column=2, sticky='w')
        ABC5 = tk.Frame(ABC4, bd=14, width=370, height=340, padx=0, bg='forest green', relief=tk.RIDGE)
        ABC5.grid(row=0, column=0, sticky='w')
        ABC6 = tk.Frame(ABC4, bd=14, width=370, height=120, padx=0, bg='forest green', relief=tk.RIDGE)
        ...
        self.lbl_fecha=tk.Label(ABC1, textvariable=fecha, font=('arial', 30, 'bold'), pady=9, bd=5, bg='green', fg="cornsilk").grid(row=0, column=0)
        self.lbl_titulo=tk.Label(ABC1, text='            Sistema de Facturación de Clientes         ', font=('arial', 30, 'bold'), pady=9, bd=5, bg='green', fg="cornsilk", justify=tk.CENTER).grid(row=0, column=1)
        self.lbl_hora=tk.Label(ABC1, textvariable=self.hora, font=('arial', 30, 'bold'), pady=9, bd=5, bg='green', fg="cornsilk").grid(row=0, column=2)
        # =============================================================================================
        # Cliente, Pelicula y Sala
        # =============================================================================================
        self.lbl_cliente = tk.Label(ABC2, font=('arial', 12, 'bold'), text="Nombre Cliente:", padx=2, fg="cornsilk", bg='forest green').grid(row=0, column=0, sticky='w')
        self.txt_cliente = tk.Entry(ABC2, font=('arial', 12, 'bold'), textvariable= self.nombre, width=30).grid(row=0, column=1, pady=3)

        self.lbl_pelicula = tk.Label(ABC2, font=('arial', 12, 'bold'), text="Pelicula:", padx=2, fg="cornsilk", bg='forest green').grid(row=1, column=0, sticky='w')
        ...
        self.lbl_sala = tk.Label(ABC2, font=('arial', 12, 'bold'), text="Sala:", padx=2, fg="cornsilk", bg='forest green').grid(row=2, column=0, sticky='w')
        ...
        # =============================================================================================
        self.lbl_palomitas = tk.Checkbutton(ABC3, text='Palomitas', variable=self.b_palomitas, onvalue=1, offvalue=0, font=('arial', 12, 'bold'), bg='green', command=self._Palomitas).grid(row=0, sticky='w')
        ...
        self.lbl_refresco = tk.Checkbutton(ABC3, text='Refresco', variable=self.b_refresco, onvalue=1, offvalue=0, font=('arial', 12, 'bold'), bg='green', command=self._Refresco).grid(row=3, sticky='w')
        ...
        self.lbl_acompanamiento = tk.Checkbutton(ABC3, text='Acompañamiento', variable=self.b_acompanamiento, onvalue=1, offvalue=0, font=('arial', 12, 'bold'), bg='green', command=self._Acompanamiento).grid(row=5, sticky='w')
        ...
        # Ticket
        # =============================================================================================
        self.ticket = tk.Text(ABC5, height=25, width=43, bd=10, font=('arial', 9, 'bold')).grid(row=0, column=0)
        # =============================================================================================
        # Botones Total, limpiar, salir
        # =============================================================================================
        self.boton_Total = tk.Button(ABC6, padx=14, pady=7, bd=5, fg='black', font=('arial', 16, 'bold'), width=5, height=2, bg='green', text="Total").grid(row=0, column=0)
        self.boton_limpiar = tk.Button(ABC6, padx=14, pady=7, bd=5, fg='black', font=('arial', 16, 'bold'), width=5, height=2, bg='green', text="Limpiar").grid(row=0, column=1)
        self.boton_salir = tk.Button(ABC6, padx=14, pady=7, bd=5, fg='black', font=('arial', 16, 'bold'), width=5, height=2, bg='green', text="Salir").grid(row=0, column=2)
